...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  useEffect(() => {
    // Small delay to ensure container is properly sized after mount
  ...
  return <div id="lights" className="w-full h-full absolute inset-0" ref={hyperspeed} style={{ width: '100vw', height: '100vh' }}></div>;
};
