...
import { ReducedMotionToggle } from "@/components/ui/reduced-motion-toggle"
          ...
          <div className="relative p-5 sm:p-8 md:p-12 lg:p-16">
            ...
            <div className="text-center mb-8 sm:mb-12">
              ...
              <div className="flex justify-center mb-4">
                <AvailabilityBadge status="available" text="Open to opportunities" />
              </div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4">
                <span className="text-gradient-green">Let's Connect</span>
              </h2>
              <p className="text-sm sm:text-base lg:text-lg text-text-secondary max-w-xl mx-auto px-2">
                Open to AI engineering and product management opportunities. Let's talk about building impactful products.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8 sm:mb-12">
              <SocialLink
                href="https://linkedin.com/in/jialanren"
                icon={
            ...
            {/* Location */}
            <div className="flex items-center justify-center gap-2 text-text-muted mb-8 sm:mb-12">
            ...
            <div className="mb-8 sm:mb-12">
              <h3 className="text-lg sm:text-xl font-medium text-center mb-6 text-text-primary">
                Or send me a message directly
              </h3>
              <ContactForm
                onSuccess={() => addToast("Thanks for reaching out! I'll get back to you soon.", "success")}
              />
            </div>
